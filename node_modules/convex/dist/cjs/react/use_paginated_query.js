...
function usePaginatedQuery(query, args, options) {
  ...
  const createInitialState = (0, import_react.useMemo)(() => {
    ...
    JSON.stringify((0, import_values.convexToJson)(args)),
    queryName,
    options.initialNumItems
  ]);
  const [state, setState] = (0, import_react.useState)(createInitialState);
  let currState = state;
  if ((0, import_api.getFunctionName)(query) !== (0, import_api.getFunctionName)(state.query) || JSON.stringify((0, import_values.convexToJson)(args)) !== JSON.stringify((0, import_values.convexToJson)(state.args))) {
