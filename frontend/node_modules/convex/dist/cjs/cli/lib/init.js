...
async function init(ctx, deploymentType = "prod", config) {
  ...
  let projectSlug, teamSlug, deploymentName, url, adminKey, projectsRemaining, projectConfig, modules;
  try {
    ({
      projectSlug,
      teamSlug,
  ...
  if (modules.length > 0) {
    (0, import_context.logFailure)(ctx, import_chalk.default.red("Error: Unexpected modules in new project"));
  ...
  const functionsPath = (0, import_utils.functionsDir)(configPath, projectConfig);
